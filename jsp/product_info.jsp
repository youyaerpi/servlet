	...
	<form id="myform" action="${pageContext.request.contextPath}/CartServlet?method=addCartItemToCart" method="post">
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">促销: <a target="_blank" title="限时抢购 (2018-07-30 ~ 2018-12-30)" style="background-color: #f07373;">限时抢购</a> </div>
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<!--向服务器发送购买数量  -->
 							购买数量:<input id="quantity" name="quantity" value="1" maxlength="4" size="10" type="text"> </div>
 							<!--向服务器发送购买数量   -->
