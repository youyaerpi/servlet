...
<html>
		...
		<div class="container-fluid">
			...
			<div class="col-md-3" style="padding-top:20px">
				...
				<c:if test="${not empty loginUser }">
					...
					<li><a href="${pageContext.request.contextPath}/UserServlet?method=logoutUI">退出</a></li>
					...
					<li class="sn-sitemap">
					   <h3 class="menu-hd">
					     <span style="font-size: 14px">网站导航</span><b></b>
                       </h3>
					</li>
				</ol>
			</div>
 ...
 <script type="text/javascript">
     ...
     $(function(){
	 //向服务器端CategoryServlet-->getAllCats发送ajax请求，服务器端经过处理，将所有分类信息以json格式的数据返回，
	 //获取到返回的分类绑定在页面的显示分类区域
	 var url="/shopping_mall/CategoryServlet";
	 var obj={"method":"findAllCats"};
	 $.post(url,obj,function(data){
		// alert(data);
		$.each(data,function(i,obj){
			var li="<li><a href='/shopping_mall/ProductServlet?method=findProductByCidWithPage&num=1&cid="+obj.cid+"'>"+obj.cname+"</a></li>";
			$("#myul").append(li);
		});
	 },"json");
 }); 
